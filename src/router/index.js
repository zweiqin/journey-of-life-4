...
export const asyncRouterMap = [
        ...
        children: [
          {
            ...
            meta: {
              title: '营销-门店', icon: 'tree-table', noCache: true,
          ...
          },
          {
            ...
            name: 'StoreMember',
            meta: {
              title: '业务员-会员', icon: 'tree-table', noCache: true,
          ...
          },
          {
            ...
            meta: {
              title: '所属门店', icon: 'tree-table', noCache: true,
          ...
          },
          {
            ...
            meta: {
              title: '所属会员', icon: 'tree-table', noCache: true,
...

  {
    ...
    redirect: 'noredirect',
    meta: {
      title: '申请管理', icon: 'log', noCache: true,
