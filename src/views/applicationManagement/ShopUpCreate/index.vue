  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        >
          <el-input
            v-model="storeDataForm.password"
            type="password"
        ...
        >
          ...
          >
            <img
              v-if="storeDataForm.avatar"
              :src="common.splicingImgUrl() +storeDataForm.avatar"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl() +storeDataForm.picUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl() +storeDataForm.licenseUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl() +storeDataForm.brandIdcardProsUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl() +storeDataForm.brandIdcardConsUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl() +marketDataForm.idcardProsUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl() +marketDataForm.idcardConsUrl"
              class="avatar"
            >
            <i
              v-else
