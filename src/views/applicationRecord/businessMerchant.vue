<template>
	<div class="app-container">
		<div v-tableHeight>
			<el-table height="100%" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
				...
				<el-table-column align="center" label="操作" class-name="small-padding fixed-width" width="250">
					<template slot-scope="scope">
						<el-button
							v-permission="[ 'GET /admin/dtsAdmin/areaUserList' ]" disabled type="primary" size="mini"
		...
		<el-dialog
			v-if="dialogFormitem !== null" :title="dialogFormitem.nickname + '旗下的营销策划师'"
			:visible.sync="dialogFormVisible" width="80%"
		>
		</el-dialog>
		<!-- <Pagination
			v-show="total > 0"
...
import {
	getBusinessList
} from '@/api/applicationRecord/businessList'
export default {
