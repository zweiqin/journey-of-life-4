    ...
    >
      ...
      >
        <el-form-item label="推广二维码">
          <img
            :src="common.splicingImgUrl()+dataForm.shareUrl"
            width="300"
          >
        </el-form-item>
      </el-form>
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl()+dataForm.picUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl()+dataForm.logoUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl()+dataForm.licenseUrl"
              class="avatar"
            >
            <i
              v-else
...
export default {
  ...
  methods: {
    ...
    confirmLocation (e) {
      ...
      this.dataForm.latitude = this.stadiumData.dataForm
    ...
    createData () {
      ...
      this.dataForm.longitude = this.stadiumData.latitude
      this.dataForm.address = this.stadiumData.addr
