<template>
	<div class="app-container">
		<div class="filter-container">
			<el-input v-model="searchID" clearable size="small" class="filter-item" style="width: 200px" placeholder="请输入ID" />
			<el-input
				v-model="searchText" clearable size="small" class="filter-item"
				style="width: 200px"
				placeholder="请输入ID"
			/>
		...
		<div v-tableHeight>
			<el-table
				v-loading="listLoading" max-height="100%" :data="selectList(searchID, searchText)" size="small"
			...
			>
				...
				<el-table-column align="center" label="操作">
					<template slot-scope="scope">
						<el-button
							v-permission="[ 'POST /admin/dtsOrderRefundsReason/update' ]" type="primary"
						...
						<el-button
							v-permission="[ 'POST /admin/dtsOrderRefundsReason/update' ]" type="danger"
		...
		<!-- 添加 -->
		<el-dialog title="添加退款申请的原因" :visible.sync="dialogFormVisible" width="80%">
			<el-input v-model="refundOtherReason" type="textarea" placeholder="请输入退款原因" />
		...
		<!-- 修改 -->
		<el-dialog title="添加退款申请的原因" :visible.sync="isUpdata" width="80%">
			<el-form ref="creatFromData" :model="fromData">
				<el-form-item label="ID" prop="id" label-width="80px">
					<el-input v-model="fromData.id" disabled style="width: 200px" autocomplete="off" />
				</el-form-item>
				<el-form-item label="退款原因" prop="id" label-width="80px">
					<el-input v-model="fromData.refundOtherReason" type="textarea" placeholder="请输入退款原因" />
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
				...
				<el-button @click="isUpdata = false">
					取消
				</el-button>
			</div>
		</el-dialog>
...
import { getRefundReason, addRefundReason, updataRefundReason, deleteRefundReason } from '@/api/configurationTable/refundReason'
export default {
	name: 'RefundReason',
