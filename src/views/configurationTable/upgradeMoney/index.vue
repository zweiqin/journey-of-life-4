<template>
	<div class="app-container">
		...
		>
			...
			<el-table-column align="center" label="升级金额名称" prop="name" />

			<el-table-column align="center" label="当前用户等级" prop="levelId" sortable />

			<el-table-column align="center" label="升级用户等级" prop="upLevelId" />

			<el-table-column align="center" label="升级金额" prop="money" />
		...
		<el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
			...
			>
				...
				<el-form-item label="升级金额名称" prop="name">
					<el-input v-model="dataForm.name" />
				</el-form-item>

				<el-form-item label="当前用户等级" prop="levelId">
					<el-input v-model="dataForm.levelId" />
				</el-form-item>

				<el-form-item label="升级用户等级" prop="upLevelId">
