<template>
	<div class="app-container">
		...
		<div class="filter-container">
			...
			/>
			<el-input
				v-show="isAdmin" v-model="listQuery.userId" clearable size="mini"
				class="filter-item"
				style="width: 200px;" placeholder="请输入会员ID"
			/>
			...
			<el-button
				v-permission="[ 'GET /admin/voucherRecord/list' ]" size="mini" class="filter-item" type="primary"
		...
		>
			...
			<el-table-column align="center" label="购买者id" prop="userId" />
			...
			<el-table-column align="center" label="微信订单编号" prop="payId" />

			<el-table-column align="center" label="消费金额" prop="payGrade" />
			...
			<el-table-column align="center" label="操作" class-name="small-padding fixed-width">
				<template slot-scope="scope">
					<el-button
						v-permission="[ 'POST /admin/admin/update' ]" :disabled="scope.row.status !== 3" type="primary"
						size="mini" @click="handleGrant(scope.row)"
					>
						发放
					</el-button>
					<!-- <el-button
