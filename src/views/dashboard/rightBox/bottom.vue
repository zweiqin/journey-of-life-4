...
"
    ...
    <div class="base">
      ...
      <titleNumber
        :name="'红包发放'"
        :parameter="number[1]+'个'"
        class="divitem"
      />
      <titleNumber
        :name="'发放金额'"
        :parameter="number[2]+'个'"
        class="divitem"
      />
      <titleNumber
        :name="'签到率'"
    ...
    <div class="base2">
      ...
      <div class="showitem">
        ...
        <div class="showtitle">参与人数</div>
        <div
          :style="{fontSize:26*$root.dw+'px'}"
          class="showtext"
        >{{ '5' }}个</div>
        <div
          :style="{fontSize:26*$root.dw+'px'}"
    ...
    <!-- <div class="tabledivstyle">
      <el-table id="table" ref="table" :show-overflow-tooltip="true" :data="tableData" :default-sort="{prop: 'date', order: 'descending'}" :row-style="rowStyle" :cell-style="cellStyle" :style="tableStyle" :header-row-style="headerRowStyle" :header-cell-style="headerCellStyle" :height="300*$root.dw+'px'" :size="'mini'">

        <el-table-column :show-overflow-tooltip="true" :width="100*$root.dw+'px'" prop="id" label="商品id" sortable align="center" />

        <el-table-column :width="80*$root.dw+'px'" :show-overflow-tooltip="true" prop="goodsname" label="入库数" align="center" />

        <el-table-column :width="80*$root.dw+'px'" :show-overflow-tooltip="true" prop="station" label="出库数" align="center" />

        <el-table-column :width="80*$root.dw+'px'" :show-overflow-tooltip="true" prop="loadCapacity" label="已收货" align="center" />

        <el-table-column :width="80*$root.dw+'px'" :show-overflow-tooltip="true" prop="loadCapacity" label="退货数" align="center" />
      </el-table>
    </div> -->
