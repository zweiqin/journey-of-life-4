<template>
	...
	>
		...
		>
			...
			>
				<el-button
					:style="{ fontSize: 14 * $root.dw + 'px', padding: 5 * $root.dw + 'px' }" type="primary"
					icon="el-icon-search" round @click="getSelectedButton(0, search)"
				/>
				<input
					v-model="search"
					...
					type="text" @keyup.enter="getSelectedButton(0, search)"
				>
			</div>
			...
			>
				...
				>
					...
					>
						...
						>
							<img :src="require('@/assets/家具工厂.png')" height="80%">
						</div>
						<div
							:style="{
								color: '#fff',
					...
					>
						...
						>
							<img :src="require('@/assets/门店.png')" height="80%">
						</div>
						<div
							:style="{
								color: '#fff',
					...
					>
						...
						>
							<img :src="require('@/assets/物流.png')" height="80%">
						</div>
						<div
							:style="{
								color: '#fff',
					...
					<div
						:style="{
							...
							justifyContent: 'center',
							alignItems: 'space-around'
						}" @click="outUrl('https://www.tuanfengkeji.cn/tf_5s/')"
					>
						<div
							:style="{
								width: '100%',
						...
						>
							<img :src="require('@/assets/社区.png')" height="80%">
						</div>
						<div
							:style="{
								color: '#fff',
				...
				>
					<div
						:style="{
							...
							justifyContent: 'center',
							alignItems: 'space-around'
						}" @click="outUrl('https://www.tuanfengkeji.cn/tfwuye/#/shop')"
					>
						<div
							:style="{
								width: '100%',
						...
						>
							<img :src="require('@/assets/数字化门店.png')" height="80%">
						</div>
						<div
							:style="{
								color: '#fff',
					...
					<div
						:style="{
							...
							justifyContent: 'center',
							alignItems: 'space-around'
						}" @click="outUrl('https://www.tuanfengkeji.cn/tfwuye/#/factory')"
					>
						<div
							:style="{
								width: '100%',
						...
						>
							<img :src="require('@/assets/数字化工厂.png')" height="80%">
						</div>
						<div
							:style="{
								color: '#fff',
					...
					>
						...
						>
							<img :src="require('@/assets/注册会员.png')" height="80%">
						</div>
						<div
							:style="{
								color: '#fff',
					...
					>
						...
						>
							<img :src="require('@/assets/师傅.png')" height="80%">
						</div>
						<div
							:style="{
								color: '#fff',
