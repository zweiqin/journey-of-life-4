<template>
	<div class="base">
		<div class="wordTitle">
			<el-button type="primary" icon="el-icon-shopping-cart-full" round>
				商品列表
			</el-button>
			...
			<div class="searchdiv" style="width:50%">
				...
				<input
					...
					type="text" @keyup.enter="callback"
				>
			</div>

			<el-button
				type="primary" icon="el-icon-top-right
" round
			>
				前往商品大屏
			</el-button>
		...
		<div class="tabledivstyle">
			<el-table
				id="table" ref="table" :show-overflow-tooltip="true" :data="tableData"
				:default-sort="{ prop: 'date', order: 'descending' }" :row-style="{
					color: 'white',
				...
				:header-row-style="{
					...
					color: 'white',
					fontSize: 18 * $root.dw + 'px'
				}" :height="370 * $root.dw + 'px'" size="mini"
			>

				<el-table-column :show-overflow-tooltip="true" width="atuo" prop="id" label="商品" align="center">
					<template slot-scope="scope">
						<div class="imgitem">
							<img
								:src="common.seamingImgUrl(scope.img || '45lxggyyww6s94m4jxv1.png')"
								:height="40 * $root.dw + 'px'"
							>
						</div>
					</template>
				</el-table-column>
				...
				<el-table-column
					:width="136.4 * $root.dw + 'px'" :show-overflow-tooltip="true" prop="goodsname" label="名称"
					align="center"
				/>

				<el-table-column
					:width="136.4 * $root.dw + 'px'" :show-overflow-tooltip="true" prop="station" label="价格(元)"
					align="center" sortable
				/>

				<el-table-column
					:width="136.4 * $root.dw + 'px'" :show-overflow-tooltip="true" prop="loadCapacity" label="成交次数"
					align="center" sortable
				/>

				<el-table-column
					:width="136.4 * $root.dw + 'px'" :show-overflow-tooltip="true" prop="loadCapacity" label="总金额(元)"
					align="center" sortable
				/>
			</el-table>
		</div>
