		...
		<el-card class="box-card">
			...
			<el-form ref="goods" :rules="rules" :model="goods" status-icon label-width="150px">
				...
				<el-form-item label="是否是预约商品" prop="isAppoint">
					<el-radio-group v-model="goods.isAppoint">
						<el-radio :label="true">是</el-radio>
						<el-radio :label="false">否</el-radio>
					</el-radio-group>
				</el-form-item>

				<el-form-item v-show="goods.isAppoint" label="开售时间" prop="startTime">
					<el-date-picker v-model="goods.startTime" placeholder="开售时间" value-format="yyyy-MM-dd HH:mm:ss" />
				</el-form-item>

				<el-form-item v-show="goods.isAppoint" label="结束时间" prop="endTime">
	...
	data() {
		return {
			...
			rules: {
				...
				brandId: [ { required: true, message: '所属品牌商不能为空', trigger: 'change' } ]
			},
