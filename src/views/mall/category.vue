    ...
    >
      ...
      >
        <template slot-scope="scope">
          <img
            ...
            :src="(common.splicingImgUrl()+scope.row.appIconUrl)"
            width="40"
          >
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <img
            v-if="scope.row.iconUrl"
            :src="common.splicingImgUrl()+scope.row.iconUrl"
            width="40"
          >
        </template>
      </el-table-column>
      ...
      >
        ...
        >
          <el-upload
            ...
            :on-success="uploadAppIconUrl"
            class="avatar-uploader"
            accept=".jpg,.jpeg,.png,.gif"
          >
            <img
              v-if="dataForm.appIconUrl"
              :src="common.splicingImgUrl()+dataForm.appIconUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl()+dataForm.iconUrl"
              class="avatar"
            >
            <i
              v-else
...
export default {
  ...
  methods: {
    ...
    uploadAppIconUrl: function (response) {
