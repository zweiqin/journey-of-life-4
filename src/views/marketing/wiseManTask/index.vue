<template>
	<div class="app-container">
		...
		<div class="filter-container">
			...
			<el-button
				v-permission="[ 'GET /admin/talentTask/list' ]" size="mini" class="filter-item" type="primary"
			...
			>
				...
				<el-table-column align="center" min-width="100px" property="img" label="图片">
					<template slot-scope="scope">
						<el-image
							v-if="scope.row.img" :src="common.splicingImgUrl() + scope.row.img" style="width:40px; height:40px" fit="cover"
							:preview-src-list="[ common.splicingImgUrl() + scope.row.img ]"
						/>
						<span v-else>--</span>
					</template>
				</el-table-column>
				...
				<el-table-column align="center" label="操作" min-width="180px" class-name="small-padding fixed-width" fixed="right">
					<template slot-scope="scope">
						<el-button
							v-permission="[ 'GET /admin/talentTask/info' ]" type="primary" size="mini"
							@click="handleDetail(scope.row)"
						>
							详情
						</el-button>
						<el-button
							v-permission="[ 'POST /admin/talentTask/update' ]" type="primary" size="mini"
