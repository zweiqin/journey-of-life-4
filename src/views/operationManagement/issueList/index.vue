<template>
	<div class="app-container">
		...
		<div class="filter-container">
			<el-input
				v-model="listQuery.question" clearable size="mini" class="filter-item"
				style="width: 200px;"
				placeholder="请输入问题"
			/>
			<el-button
				v-permission="[ 'GET /admin/issue/list' ]" size="mini" class="filter-item" type="primary"
				icon="el-icon-search" @click="handleFilter"
			>
				查找
			</el-button>
			<el-button
				v-permission="[ 'POST /admin/issue/create' ]" size="mini" class="filter-item" type="primary"
			...
			>
				...
				<el-table-column align="center" label="操作" width="250" class-name="small-padding fixed-width">
					<template slot-scope="scope">
						<el-button
							v-permission="[ 'POST /admin/issue/update' ]" type="primary" size="mini"
							@click="handleUpdate(scope.row)"
						>
							编辑
						</el-button>
						<el-button
							v-permission="[ 'POST /admin/issue/delete' ]" type="danger" size="mini"
...
<script>
import { listIssue, createIssue, updateIssue, deleteIssue } from '@/api/operationManagement/issue'
