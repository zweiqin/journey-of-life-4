<template>
	<div class="app-container">
		...
		<div class="filter-container">
			...
			/>
			<el-input
				v-model="listQuery.url" clearable size="mini" class="filter-item"
				style="width: 200px;"
				placeholder="请输入跳转链接"
			/>
			<el-button
				v-permission="[ 'GET /admin/keyword/list' ]" size="mini" class="filter-item" type="primary"
				icon="el-icon-search" @click="handleFilter"
			>
				查找
			</el-button>
			<el-button
				v-permission="[ 'POST /admin/keyword/create' ]" size="mini" class="filter-item" type="primary"
		...
		<div v-tableHeight>
			...
			>
				...
				<el-table-column align="center" label="操作" width="250" class-name="small-padding fixed-width">
					<template slot-scope="scope">
						<el-button
							v-permission="[ 'POST /admin/keyword/update' ]" type="primary" size="mini"
							@click="handleUpdate(scope.row)"
						>
							编辑
						</el-button>
						<el-button
							v-permission="[ 'POST /admin/keyword/delete' ]" type="danger" size="mini"
...
<script>
import { listKeyword, createKeyword, updateKeyword, deleteKeyword } from '@/api/operationManagement/keyword'
