<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      />
      <el-button
        v-permission="['GET /admin/brandSalesman/list']"
        size="mini"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
      ...
      >查找</el-button>
      <el-button
        v-permission="['POST /admin/brandSalesman/add']"
        size="mini"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['POST /admin/brandSalesman/update']"
            type="primary"
            size="mini"
            @click="handleUpdate(scope.row)"
          >编辑</el-button>
          <el-button
            v-permission="['POST /admin/brandSalesman/delete']"
            type="danger"
            size="mini"
      ...
      >
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl()+dataForm.avatar"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          <el-select
            ...
            placeholder="请选择"
            filterable
            @change="getAdSalesman(dataForm.brandId)"
          >
            <el-option
        ...
        >
          <el-select
            ...
            :disabled="selectBrandId!==''?false:true"
            placeholder="请选择"
            filterable
            clearable
          >
            <el-option
              v-for="item in AdSalesmanOptions"
              :key="item.id"
              :label="item.name"
              :value="item.id"
            />
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl()+dataForm.idcardProsUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          ...
          >
            <img
              ...
              :src="common.splicingImgUrl()+dataForm.idcardConsUrl"
              class="avatar"
            >
            <i
              v-else
        ...
        >
          <el-input
            ...
            @change="userGet(dataForm.userId)"
          />
