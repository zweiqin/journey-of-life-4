<template>
	<div class="app-container">
		...
		<div class="filter-container">
			<el-input
				v-model="listQuery.key" clearable size="mini" class="filter-item"
				style="width: 200px;"
			...
			/>
			<el-button
				v-permission="[ 'GET /admin/storage/list' ]" size="mini" class="filter-item" type="primary"
				icon="el-icon-search" @click="handleFilter"
			>
				查找
			</el-button>
			<el-button
				v-permission="[ 'POST /admin/storage/create' ]" size="mini" class="filter-item" type="primary"
		...
		>
			...
			<el-table-column align="center" min-width="80px" property="url" label="图片">
				<template slot-scope="scope">
					<img :src="common.seamingImgUrl(scope.row.url)" width="40">
				</template>
			</el-table-column>

			<el-table-column align="center" min-width="180px" label="图片链接" prop="url">
				<template slot-scope="scope">
					{{ common.seamingImgUrl(scope.row.url) }}
				</template>
			</el-table-column>
			...
			<el-table-column align="center" min-width="120px" label="操作" class-name="small-padding fixed-width">
				<template slot-scope="scope">
					<el-button
						v-permission="[ 'POST /admin/storage/update' ]" type="primary" size="mini"
						@click="handleUpdate(scope.row)"
					>
						编辑
					</el-button>
					<el-button
						v-permission="[ 'POST /admin/storage/delete' ]" type="danger" size="mini"
